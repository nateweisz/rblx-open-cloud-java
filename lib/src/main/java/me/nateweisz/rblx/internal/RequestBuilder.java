...
public class RequestBuilder {
	...
	public RequestBuilder(String endpoint) {
		requestBuilder = HttpRequest.newBuilder().uri(URI.create(Endpoints.V2_BASE_URL + endpoint));
	}
	...
	public RequestBuilder patch(Object body) {
		try {
			requestBuilder.setHeader("Content-Type", "application/json").method("PATCH",
